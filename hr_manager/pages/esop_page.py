...
_COLS = ["工号", "姓名", "授予日期", "授予份额", "已归属", "未归属", "饱和度", "年度指导线", "人才识别"]
...
class EsopPage(QWidget):
    ...
    def _load_table(self, _=None):
        ...
        for row, s in enumerate(records):
            ...
            vals = [
                ...
                f"{s.shares_vested:,.0f}",
                f"{s.shares_unvested:,.0f}",
                sat_text,
    ...
    def _selected_esop_id(self) -> int | None:
